...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        filename = 'keras_yolo3_{0}_{1}.json'.format(strftime("%Y%m%d%H%M%S",gmtime()),uuid.uuid4())
...
def detect_video(yolo, video_path):
    ...
    while True:
        ...
        imgfilename = '/Volumes/seagate/projects/keras-yolo3/images/keras_yolo3_{0}_{1}.jpg'.format(strftime("%Y%m%d%H%M%S",gmtime()),uuid.uuid4())
